  ...
  return (
    <section className="relative pt-24 pb-20 md:pt-32 md:pb-32 min-h-screen overflow-hidden flex flex-col items-center">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 text-center">
        ...
        <div
          className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass mb-8 animate-slide-up opacity-0"
        ...
        {/* HERO TITLE */}
        <h1
          className="text-5xl md:text-7xl font-display font-bold leading-tight mb-8 animate-slide-up opacity-0"
          style={{ animationDelay: "0.2s" }}
        >
          Create <span className="text-gradient-accent">Stunning</span> Client
          <br />
        ...
        {/* SUBTITLE */}
        <p
          className="text-xl md:text-2xl text-gray-400 mb-12 max-w-3xl mx-auto animate-slide-up opacity-0"
          style={{ animationDelay: "0.3s" }}
        >
          Generate high-converting proposals instantly with AI-powered
          structure, smart pricing, and analytics.
        </p>

        {/* CTA BUTTONS - SMOOTH HOVER SCALE */}
        <div
          className="flex flex-col sm:flex-row gap-4 justify-center mb-20 animate-slide-up opacity-0"
        ...
        >
          ...
          <div className="h-24 px-10 border-b border-white/5 flex items-center justify-between bg-[#0B0F19]">
            <div className="flex items-center gap-4">
              <span className="text-gray-500 font-medium text-lg hover:text-accent-indigo transition-colors duration-500 cursor-pointer">
                Home
              </span>
              <ChevronRight className="w-5 h-5 text-gray-700" />
              <span className="text-white font-extrabold text-lg tracking-tight hover:text-accent-mint transition-colors duration-500 cursor-default">
                Example Proposal
              </span>
            </div>
          ...
          <div className="p-10 md:p-12 grid grid-cols-1 md:grid-cols-[1.2fr_1fr] gap-8">
            ...
            <div className="flex flex-col gap-8">
              ...
              >
                <div
                  className="w-12 h-12 rounded-2xl bg-accent-mint/10 flex items-center justify-center mb-6
              ...
              >
                <div
                  className="w-12 h-12 rounded-2xl bg-accent-purple/10 flex items-center justify-center mb-6
                  transition-transform duration-300 ease-out hover:scale-110"
                >
