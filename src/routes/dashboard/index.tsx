    ...
    <div className="p-8 max-w-5xl mx-auto animate-slide-up space-y-10">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <button
            onClick={onBack}
            className="p-2.5 hover:bg-white/5 rounded-xl text-gray-400 transition-all duration-300 hover:text-white hover:scale-110"
          >
            <ArrowLeft />
          </button>
          <div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="glass p-8 rounded-3xl border border-white/5 space-y-6">
            ...
            <div className="p-5 rounded-2xl bg-white/[0.02] border border-white/5 flex items-center justify-between group hover:border-white/10 transition-all duration-300">
              <div className="flex items-center gap-4">
                <div className="w-12 h-8 bg-navy-900 rounded border border-white/10 flex items-center justify-center font-bold text-[10px] tracking-tighter">
                  VISA
                </div>
                <div>
              ...
              <button className="text-xs font-bold text-accent-indigo hover:text-accent-mint transition-colors">
                Update
              </button>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {Object.values(TEMPLATE_MAP)
          ...
          .map((t) => (
            <div
              key={t.id}
              className="glass p-8 rounded-3xl border border-white/5 hover:border-accent-indigo/30 hover:bg-white/[0.04] transition-all duration-300 ease-in-out group flex flex-col justify-between"
            >
              <div>
                <div
                ...
                <div className="flex items-center gap-8">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-gray-500">
                      This information will be displayed on your generated
                      proposals.
                    </p>
              ...
              <div className="glass p-8 rounded-3xl border border-white/5 space-y-10">
                ...
                <div className="space-y-4 pt-4 border-t border-white/5">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {["Inter", "Manrope", "Plus Jakarta", "Geist"].map(
                      (font) => (
                        <button
                          key={font}
              ...
              <div className="glass p-8 rounded-3xl border border-white/5 space-y-8">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      Standardize your profitability across all automated
                      proposals.
                    </p>
                  </div>
            ...
            <div className="space-y-8 animate-slide-up">
              <div className="glass p-8 rounded-3xl border border-white/5 space-y-8">
                ...
                <div className="pt-6 border-t border-red-500/10">
                  <h4 className="text-red-500 font-bold text-sm mb-4">
                    Danger Zone
                  </h4>
        ...
        <div className="px-8 py-4 border-b border-white/5 flex items-center justify-between bg-white/[0.01]">
          <div className="flex items-center gap-4">
            ...
            <h2 className="font-bold">
              {formData.clientName} - {config.label} Proposal
            </h2>
          </div>
...
const ProposalDetailView = ({
  ...
  <div className="p-8 max-w-5xl mx-auto animate-slide-up">
    <div className="flex items-center gap-4 mb-8">
      <button
        onClick={onBack}
        className="p-2.5 hover:bg-white/5 rounded-xl text-gray-400 transition-all hover:text-white"
      >
        <ArrowLeft />
      </button>
      <div>
        ...
        <p className="text-sm text-gray-500">
          Drafted for {proposal.client} on {proposal.time}
        </p>
      </div>
    </div>
    ...
    switch (activeTab) {
      ...
      case "wizard":
        const config = selectedTemplateId
          ? TEMPLATE_MAP[selectedTemplateId]
          : TEMPLATE_MAP["custom"];
        return <TemplateWizard config={config} onBack={backToDash} />;
      case "proposal-view":
        return viewingProposal ? (
          <ProposalDetailView proposal={viewingProposal} onBack={backToDash} />
        ) : null;
      case "templates":
      ...
      case "settings":
        return (
          <SettingsPanel onManageBilling={() => setActiveTab("billing")} />
        );
      case "billing":
