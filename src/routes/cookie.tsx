  ...
  return (
    <div className="bg-navy-900 min-h-screen text-white">
      ...
      <div className="pt-32 pb-20">
        <SectionHeader
          title="Cookie Policy"
          subtitle="Understanding how we use cookies to provide a better experience."
        />
        <div className="max-w-3xl mx-auto px-6 text-gray-400 space-y-8 leading-relaxed">
          <section className="space-y-4">
            <p>
              This is the Cookie Policy for ClosePilot, accessible from
              closepilot.com. We believe in being clear and open about how we
              collect and use data related to you.
            </p>
            <p>
              To provide you with a seamless experience, we use cookies and
              similar technologies. This policy describes what these
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc pl-5 space-y-4">
              <li>
                ...
                which amount to a request for services, such as setting your
                privacy preferences, logging in, or filling in forms.
              </li>
              <li>
                <strong>Preference Cookies:</strong> We use these to remember
                your settings and preferences. For example, we may remember your
                language preferences or the configuration of your dashboard.
              </li>
              <li>
                <strong>Analytics Cookies:</strong> These allow us to count
              ...
              <li>
                <strong>Marketing Cookies:</strong> These cookies are set
                ...
                you relevant adverts on other sites. They do not store directly
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              deliver advertisements on and through the Service, and so on. For
            ...
            <ul className="list-disc pl-5 space-y-2">
              <li>
                ...
                <a
                  ...
                  className="text-accent-indigo hover:text-accent-mint transition-colors"
                >
                  Clear cache & cookies
                </a>
              </li>
          ...
          <section className="space-y-4">
            ...
            <p>
              We hope that has clarified things for you. As was previously
            ...
            <p>
              ...
              can contact us through our preferred contact methods on the
              contact page.
            </p>
          </section>
        </div>
