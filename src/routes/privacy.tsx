      ...
      <div className="pt-32 pb-20">
        ...
        <div className="max-w-3xl mx-auto px-6 text-gray-400 space-y-8 leading-relaxed">
          <section className="space-y-4">
            <p>
              At ClosePilot, accessible from closepilot.com, one of our main
              priorities is the privacy of our visitors. This Privacy Policy
              document contains types of information that is collected and
              recorded by ClosePilot and how we use it.
            </p>
            <p>
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li>
                <strong>Communication Data:</strong> If you contact us directly,
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc pl-5 space-y-2">
              <li>
                Provide, operate, and maintain our website and proposal
                services.
              </li>
              <li>
                Improve, personalize, and expand our website features and AI
                models.
              </li>
              <li>
                Understand and analyze how you use our website to optimize the
                user experience.
              </li>
              <li>
          ...
          <section className="space-y-4">
            ...
            <p>
              ClosePilot follows a standard procedure of using log files. These
            ...
            <p>
              Like any other website, ClosePilot uses 'cookies'. These cookies
