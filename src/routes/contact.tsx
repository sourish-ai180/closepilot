          ...
          <div className="lg:col-span-1 space-y-10">
            <div>
              ...
              <p className="text-gray-400 mb-8 leading-relaxed">
                We're a remote-first team but always happy to connect. Whether
                you're experiencing a technical issue or just want to chat about
                sales strategy, our team is standing by.
              </p>
            </div>
          ...
          <div className="lg:col-span-2">
            <div className="glass p-8 md:p-12 rounded-3xl border border-white/10 shadow-2xl relative overflow-hidden">
              ...
              >
                ...
                <Button
                  variant="primary"
                  className="w-full py-5 text-lg shadow-xl shadow-accent-indigo/20"
                >
                  Send Message
                </Button>
