      ...
      <div className="pt-32 pb-20">
        ...
        <div className="max-w-3xl mx-auto px-6 text-gray-400 space-y-8 leading-relaxed">
          <section className="space-y-4">
            <p>
              Welcome to ClosePilot. By using our website and services, you
              agree to comply with and be bound by the following terms and
              conditions of use, which together with our privacy policy govern
              ClosePilot's relationship with you in relation to this website.
            </p>
            <p>
              The term 'ClosePilot' or 'us' or 'we' refers to the owner of the
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              materials on ClosePilot's website for personal, non-commercial
              transitory viewing only. This is the grant of a license, not a
              transfer of title, and under this license you may not:
            </p>
            <ul className="list-disc pl-5 space-y-2">
              <li>
                Modify or copy the materials or AI-generated output for resale
                as a standalone product.
              </li>
              <li>
                Use the materials for any commercial purpose, or for any public
                display (commercial or non-commercial) unless explicitly
                permitted by your subscription plan.
              </li>
              <li>
                Attempt to decompile or reverse engineer any software contained
                on ClosePilot's website.
              </li>
              <li>
            ...
            <p>
              ...
              these restrictions and may be terminated by ClosePilot at any
              time.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              ClosePilot uses AI to generate proposals based on your inputs. You
              acknowledge that AI-generated content may occasionally be
              inaccurate or inappropriate and you agree to review all output
              before sending it to clients.
            </p>
            <p>
              You must not use our service to generate content that is unlawful,
          ...
          <section className="space-y-4">
            ...
            <p>
              The materials on ClosePilot's website are provided "as is".
              ClosePilot makes no warranties, expressed or implied, and hereby
            ...
            <p>
              Further, ClosePilot does not warrant or make any representations
          ...
          <section className="space-y-4">
            ...
            <p>
              In no event shall ClosePilot or its suppliers be liable for any
              damages (including, without limitation, damages for loss of data
              or profit, or due to business interruption) arising out of the use
              or inability to use the materials on ClosePilot's website, even if
              ClosePilot or a ClosePilot authorized representative has been
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              exclusive property of ClosePilot and its licensors. Our trademarks
              and trade dress may not be used in connection with any product or
              service without the prior written consent of ClosePilot.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              accordance with the laws of the jurisdiction in which ClosePilot
