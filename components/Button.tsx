...
const Button: React.FC<ButtonProps> = ({ 
  ...
  const baseStyle = "px-6 py-3 rounded-xl font-semibold transition-all duration-300 flex items-center justify-center gap-2 relative overflow-hidden group";
  
  const variants = {
    primary: "bg-gradient-to-r from-accent-indigo to-accent-purple text-white hover:shadow-[0_0_20px_rgba(93,95,239,0.5)] hover:scale-[1.02]",
    secondary: "bg-white text-navy-900 hover:bg-gray-100 hover:scale-[1.02]",
    outline: "border border-white/20 bg-white/5 backdrop-blur-sm text-white hover:bg-white/10 hover:border-accent-mint/50",
