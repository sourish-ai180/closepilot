...
const Templates: React.FC = () => {
  const templates = [
    ...
    { 
      ...
      image: "https://images.unsplash.com/photo-1633533446213-a438ff5f0629?q=80&w=714&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
    },
    { 
    ...
    { 
      ...
      image: "https://images.unsplash.com/photo-1502209877429-d7c6df9eb3f9?q=80&w=1466&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
    },
    { 
  ...
  return (
    <section id="templates" className="py-24 overflow-hidden">
      <SectionHeader title="Start with a Pro Template" subtitle="Don't reinvent the wheel. Choose from our library of high-converting structures." />
      
      <div className="flex overflow-x-auto pb-12 gap-6 px-4 md:px-8 max-w-[100vw] scrollbar-hide snap-x">
        {templates.map((t, i) => (
          <div key={i} className="snap-center shrink-0 w-[300px] md:w-[350px] aspect-[4/5] glass rounded-2xl relative group overflow-hidden cursor-pointer border border-white/5 hover:border-white/20 transition-all duration-500 shadow-xl">
             {/* Image Background */}
             ...
             <div className={`absolute inset-0 bg-gradient-to-br ${t.color} opacity-20 group-hover:opacity-30 mix-blend-overlay transition-opacity duration-500`} />
             ...
             <div className="absolute bottom-0 left-0 w-full p-6 bg-gradient-to-t from-navy-900 via-navy-900/90 to-transparent translate-y-2 group-hover:translate-y-0 transition-transform duration-300 z-10">
               <h3 className="text-xl font-bold mb-2 text-white drop-shadow-md">{t.name}</h3>
