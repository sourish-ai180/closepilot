  ...
  return (
    <section id="customers" className="py-24 overflow-hidden relative">
      ...
      <div className="max-w-7xl mx-auto px-6 mb-16 text-center relative z-10">
        <h2 className="text-3xl md:text-4xl font-display font-bold mb-6">Why Early Users Are Excited</h2>
        <p className="text-gray-400 max-w-2xl mx-auto text-lg">
          Real creators, freelancers, and agencies are already experiencing meaningful improvements in the way they work.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-8 px-4 max-w-7xl mx-auto relative z-10">
        {benefits.map((item, idx) => (
          ...
          >
            ...
            <div className={`w-14 h-14 rounded-2xl flex items-center justify-center mb-6 border transition-transform duration-300 group-hover:scale-110 ${item.color}`}>
              <item.icon size={28} />
            </div>
